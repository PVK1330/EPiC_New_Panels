/**
 * Static country / nationality reference data.
 *
 * Mirrors the shape you'd get from the free REST Countries API
 * (https://restcountries.com/v3.1/all?fields=name,cca2,idd,demonyms,flags)
 * so it can be swapped for a live fetch later without touching callers.
 *
 * Each entry:
 *   code        ISO 3166-1 alpha-2  (e.g. "IN")  — also used by libphonenumber
 *   name        Common country name (e.g. "India")
 *   nationality Demonym             (e.g. "Indian")  ← use for a "Nationality" field
 *   dialCode    E.164 calling code  (e.g. "+91")
 *   flag        Flag emoji          (e.g. "🇮🇳")
 *
 * Use the helpers at the bottom rather than reaching into the array directly.
 */
...
export const COUNTRIES = [
  ...
  { code: "DZ", name: "Algeria", nationality: "Algerian", dialCode: "+213", flag: "🇩🇿" },
  ...
  { code: "CU", name: "Cuba", nationality: "Cuban", dialCode: "+53", flag: "🇨🇺" },
  { code: "CY", name: "Cyprus", nationality: "Cypriot", dialCode: "+357", flag: "🇨🇾" },
  { code: "CZ", name: "Czechia", nationality: "Czech", dialCode: "+420", flag: "🇨🇿" },
  ...
  { code: "ET", name: "Ethiopia", nationality: "Ethiopian", dialCode: "+251", flag: "🇪🇹" },
  ...
  { code: "GH", name: "Ghana", nationality: "Ghanaian", dialCode: "+233", flag: "🇬🇭" },
  ...
  { code: "IS", name: "Iceland", nationality: "Icelandic", dialCode: "+354", flag: "🇮🇸" },
  { code: "IN", name: "India", nationality: "Indian", dialCode: "+91", flag: "🇮🇳" },
  { code: "ID", name: "Indonesia", nationality: "Indonesian", dialCode: "+62", flag: "🇮🇩" },
  { code: "IR", name: "Iran", nationality: "Iranian", dialCode: "+98", flag: "🇮🇷" },
  { code: "IQ", name: "Iraq", nationality: "Iraqi", dialCode: "+964", flag: "🇮🇶" },
  ...
  { code: "JM", name: "Jamaica", nationality: "Jamaican", dialCode: "+1", flag: "🇯🇲" },
  { code: "JP", name: "Japan", nationality: "Japanese", dialCode: "+81", flag: "🇯🇵" },
  { code: "JO", name: "Jordan", nationality: "Jordanian", dialCode: "+962", flag: "🇯🇴" },
  ...
  { code: "LB", name: "Lebanon", nationality: "Lebanese", dialCode: "+961", flag: "🇱🇧" },
  ...
  { code: "PS", name: "Palestine", nationality: "Palestinian", dialCode: "+970", flag: "🇵🇸" },
  ...
  { code: "SY", name: "Syria", nationality: "Syrian", dialCode: "+963", flag: "🇸🇾" },
  { code: "TW", name: "Taiwan", nationality: "Taiwanese", dialCode: "+886", flag: "🇹🇼" },
  { code: "TZ", name: "Tanzania", nationality: "Tanzanian", dialCode: "+255", flag: "🇹🇿" },
  { code: "TH", name: "Thailand", nationality: "Thai", dialCode: "+66", flag: "🇹🇭" },
  { code: "TN", name: "Tunisia", nationality: "Tunisian", dialCode: "+216", flag: "🇹🇳" },
  { code: "TR", name: "Turkey", nationality: "Turkish", dialCode: "+90", flag: "🇹🇷" },
  { code: "UG", name: "Uganda", nationality: "Ugandan", dialCode: "+256", flag: "🇺🇬" },
  ...
  { code: "YE", name: "Yemen", nationality: "Yemeni", dialCode: "+967", flag: "🇾🇪" },
  { code: "ZM", name: "Zambia", nationality: "Zambian", dialCode: "+260", flag: "🇿🇲" },
  { code: "ZW", name: "Zimbabwe", nationality: "Zimbabwean", dialCode: "+263", flag: "🇿🇼" },
];
