...
export function candidateRowToApplicationForm(c) {
  ...
  if (c.application && typeof c.application === "object") {
    ...
    return {
      ...
      refusedVisaType: app.refusedVisaType || "",
      refusedVisaReference: app.refusedVisaReference || "",
  ...
  return {
    ...
    refusedVisaReason: c.refusedVisaReason ?? c.refusedVisaDetails ?? "",
    refusedVisaDate: formatDateForInput(c.refusedVisaDate),
    refusedVisaCountry: c.refusedVisaCountry ?? "",
    refusedVisaType: c.refusedVisaType ?? "",
    refusedVisaReference: c.refusedVisaReference ?? "",
    refusedVisaDetails: c.refusedVisaDetails ?? "",
    refusedEntry: "",
    refusedEntryDetails: "",
    refusedPermission: "",
