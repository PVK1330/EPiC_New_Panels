...
export default function DocumentChecklistSettings() {
  ...
  const selectedVisa = Array.isArray(visaTypes)
    ? visaTypes.find((v) => v.id === parseInt(selectedVisaTypeId))
    : null;
          ...
          {loading ? (
            ...
            <div className="py-12 text-center">
              <p className="text-sm text-gray-400 italic">
                Select a visa type to view its document checklist.
              </p>
            </div>
          ) : (
            <>
              <div className="flex items-center justify-between mb-4">
                <p className="text-sm text-gray-600">
                  <span className="font-semibold">{checklist.length}</span>{" "}
                  documents configured for{" "}
              ...
              {checklist.length === 0 ? (
                <div className="py-12 text-center border-2 border-dashed border-gray-200 rounded-2xl">
                  <p className="text-sm text-gray-400 italic">
                    No documents configured for this visa type.
                  </p>
                  <p className="text-xs text-gray-400 mt-1">
                    Click "Add Document" to create the checklist.
                  </p>
                </div>
              ) : (
