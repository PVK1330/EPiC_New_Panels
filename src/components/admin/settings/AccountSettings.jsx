        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              {
                id: "case_updates",
                label: "Real-time Case Updates",
                desc: "Get browser alerts for status changes",
                icon: <FiBell />,
              },
              {
                id: "payment_alerts",
                label: "Billing & Payment Alerts",
                desc: "Notifications for invoices and payments",
                icon: <FiCreditCard />,
              },
              {
                id: "data_collection",
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h5 className="text-sm font-bold text-secondary leading-none mb-1">
                      {pref.label}
                    </h5>
