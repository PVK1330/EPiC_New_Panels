...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const [statsRes, casesRes, activitiesRes, messagesRes] =
          await Promise.all([
        ...
        setRecentMessages(
          messagesRes.data.data.conversations?.slice(0, 5) || [],
        );
      } catch (error) {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      alert(
        "Failed to capture dashboard snapshot. Please ensure your browser supports advanced CSS capturing.",
      );
    } finally {
  ...
  return (
    <div ref={dashboardRef} className="pb-10 p-4">
      <Skeleton
      ...
      >
        <div className="space-y-8">
          ...
          >
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                onClick={() =>
                  setDashboardFilter(
                    dashboardFilter === "all" ? "this_month" : "all",
                  )
                }
          ...
          >
            {/* Team Workload */}
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 flex flex-col">
              <h3 className="text-sm font-black text-secondary mb-5">
                👥 Team Workload
              </h3>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                <div className="bg-green-50 rounded-xl p-4 text-center">
                  ...
                  <p className="text-2xl font-black text-green-600">
                    £
                    {(
                      dashboardStats?.financeStats?.totalRevenue || 0
                    ).toLocaleString()}
                  </p>
                </div>
                <div className="bg-red-50 rounded-xl p-4 text-center">
                  ...
                  <p className="text-2xl font-black text-red-500">
                    £
                    {(
                      dashboardStats?.financeStats?.totalOutstanding || 0
                    ).toLocaleString()}
                  </p>
                </div>
              </div>
              ...
              <div className="flex-1">
                {dashboardStats?.financeStats?.outstandingSponsors?.length >
                0 ? (
                  dashboardStats.financeStats.outstandingSponsors.map(
                    (c, i) => (
                      <div
                        key={i}
                        className={`flex items-center justify-between py-2.5 ${
                          i <
                          dashboardStats.financeStats.outstandingSponsors
                            .length -
                            1
                      ...
                      >
                        ...
                        <p className="text-xs font-black font-mono text-red-500">
