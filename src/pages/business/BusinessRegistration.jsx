      ...
      case 1:
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
                  placeholder="Enter official registered name"
                />
              </div>
              <div>
                <label className="text-sm font-semibold text-slate-700">Trading Name</label>
                <input
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                <label className="text-sm font-semibold text-slate-700">Company Registration Number *</label>
                <input
              ...
              <div>
                <label className="text-sm font-semibold text-slate-700">Sponsor Licence Number *</label>
                <input
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                <label className="text-sm font-semibold text-slate-700">Licence Rating *</label>
                <select
      ...
      case 2:
        return (
          <div className="space-y-6">
            ...
            <div>
              <label className="text-sm font-semibold text-slate-700">Trading Address</label>
              <textarea
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div>
                <label className="text-sm font-semibold text-slate-700">Authorising Officer Name</label>
                <input
            ...
            <div className="border-t border-slate-200 pt-6">
              <h3 className="text-lg font-semibold text-slate-800 mb-4">Key Contact</h3>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div>
            ...
            <div className="border-t border-slate-200 pt-6">
              <h3 className="text-lg font-semibold text-slate-800 mb-4">Level 1 Users</h3>
              <div className="space-y-4">
                {form.level1Users.map((user, index) => (
                  <div key={index} className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                    <p className="text-sm font-semibold text-slate-700 mb-3">User {index + 1}</p>
              ...
              <button
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-xl bg-red-800 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <Plus size={16} />
                Add Level 1 User
              </button>
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div>
                <label className="text-sm font-semibold text-slate-700">HR Manager Name</label>
                <input
                  value={form.hrName}
              ...
              <div>
                <label className="text-sm font-semibold text-slate-700">HR Manager Email</label>
                <input
                  value={form.hrEmail}
              ...
              <div>
                <label className="text-sm font-semibold text-slate-700">HR Manager Phone</label>
                <input
                  value={form.hrPhone}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              <div>
                <label className="text-sm font-semibold text-slate-700">Licence Issue Date</label>
                <input
                  type="date"
              ...
              <div>
                <label className="text-sm font-semibold text-slate-700">Licence Expiry Date</label>
                <input
                  type="date"
              ...
              <div>
                <label className="text-sm font-semibold text-slate-700">CoS Allocation</label>
                <input
              ...
              <div>
                <label className="text-sm font-semibold text-slate-700">Licence Status</label>
                <select
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                <div className="flex items-center gap-3 mb-4 text-slate-700">
                  <FileText size={20} />
                  <span className="font-semibold">Business Documents</span>
                </div>
                <div className="space-y-4">
                  {[
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="mb-8 gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">Complete the registration in a few simple steps.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
            <div className="flex items-center gap-3 text-slate-700 mb-4">
              ...
              <h2 className="text-lg font-semibold">Step {step}: {steps.find((item) => item.id === step)?.label}</h2>
            </div>
            {renderStepContent()}
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
            <button
              ...
              onClick={prevStep}
              disabled={step === 1}
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-300 bg-gray-400 text-gray px-6 py-3 text-sm font-semibold shadow-sm transition disabled:cursor-not-allowed disabled:opacity-50"
            >
              <ArrowLeft size={16} />
              Previous
            </button>
            <div className="flex gap-3">
              {step < steps.length && (
                <button
                  type="button"
                  onClick={nextStep}
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-red-800 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-red-700"
                >
                  Next
                  <ArrowRight size={16} />
                </button>
              ...
              {step === steps.length && (
                <button
                  type="submit"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-red-700 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-red-800"
                >
                  Submit Registration
                  <ArrowRight size={16} />
                </button>
